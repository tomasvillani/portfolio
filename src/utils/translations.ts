export const translations = {
  en: {
    ...
    planzaroteDescription: "PLanzarote is a web platform developed with Laravel that allows users to create, discover, and join plans and activities in Lanzarote. The application includes user authentication, full plan management, search functionality, activity participation, image uploads, and access control. It also features scheduled tasks to automatically manage expired plans.",
    planzaroteImage: "Screenshot of PLanzarote",
  ...
  es: {
    ...
    planzaroteDescription: "PLanzarote es una plataforma web desarrollada con Laravel que permite a los usuarios crear, descubrir y participar en planes y actividades en Lanzarote. La aplicación incluye autenticación de usuarios, gestión completa de planes, búsqueda por diferentes criterios, participación en actividades, subida de imágenes y control de permisos. También incorpora un sistema de tareas programadas para gestionar automáticamente los planes caducados.",
    planzaroteImage: "Captura de PLanzarote",
